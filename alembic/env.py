"""Модуль для указания переменных для миграции"""
import asyncio
...
SQLALCHEMY_URL = settings.postgresql_url_async
section = alembic_config.config_ini_section
alembic_config.set_section_option(section, 'SQLALCHEMY_URL', SQLALCHEMY_URL)
